...
class ClassifierClass(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    fun recognizeImage(bitmap: Bitmap): List<ClassifierClass.Recognition> {
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<ClassifierClass.Recognition> {
        ...
        for (i in LABEL_LIST.indices) {
            ...
            if (confidence >= THRESHOLD) {
                pq.add(ClassifierClass.Recognition("" + i,
